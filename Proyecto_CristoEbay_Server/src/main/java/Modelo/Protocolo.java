...
public class Protocolo {
    ...
    //                    rsv.next();
            ...
            output = "PROTOCOLCRISTOBAY1.0#GET_SUBASTA#"+rsa.getInt("id_articulo")+"@"+rs.getString("fecha_inicio")+"@"+rs.getString("fecha_fin")+"#"+rsa.getString("descripcion")+"#"+rsa.getString("imagen").split("\\.")[1]+"#"+Base64.getEncoder().encodeToString(fileContent).length();
